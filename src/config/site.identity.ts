export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'malaysiafokus',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Malaysiafokus',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'malaysiafokus.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://malaysiafokus.com',
